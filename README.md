...
This is a mirror of the official `silicon.lua` repository which was taken down
by the original author. I do not plan to do any development of the plugin. This
exists simply because I want to keep using the plugin in my setup.
